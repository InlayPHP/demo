                ...
                slots={{
                    ...
                    sidebarFooter: ({ collapsed }) =>
                        collapsed ? (
                            ...
                            <div
                                className="rounded-(--inlay-radius) border border-(--inlay-panel-sidebar-border) bg-(--inlay-panel-sidebar-hover) p-3"
                                data-slot="workspace-card"
                            >
                                <div className="mb-2 flex items-center justify-between">
                                    ...
                                    <span
                                        ...
                                        className="size-2 rounded-full bg-(--inlay-panel-success) shadow-[0_0_0_3px_var(--inlay-panel-success-surface)]"
                                    />
                                </div>
                                <p className="text-sm font-semibold text-(--inlay-panel-sidebar-text)">
